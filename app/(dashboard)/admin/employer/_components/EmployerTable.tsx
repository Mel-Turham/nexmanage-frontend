        ...
        <div className="flex flex-row w-full gap-4">
          <div className="relative">
            <select
              ...
              className={`appearance-none border rounded-full w-full px-5 py-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white cursor-pointer`}
            >
